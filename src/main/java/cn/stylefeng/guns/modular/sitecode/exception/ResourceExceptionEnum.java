package cn.stylefeng.guns.modular.sitecode.exception;
...
public enum ResourceExceptionEnum implements AbstractExceptionEnum {
    ...
    /** *资源不存在   */
    RESOURCE_NOT_EXISTED(RuleConstants.USER_OPERATION_ERROR_TYPE_CODE + ProjectConstants.BUSINESS_EXCEPTION_STEP_CODE + "01", "资源不存在");
